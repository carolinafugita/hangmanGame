...
renderLetra (j) {
    return (
        <button
          key = {this.letras[j]}
          className = "letra"
          disabled = {this.props.botaoClicado[j]}
          value = {j}
    ...
    return(
        <div>
          ...
          <div className = "teclado">
            ...
            {this.renderLetra(30)}{this.renderLetra(31)}{this.renderLetra(32)}
            {this.renderLetra(33)}{this.renderLetra(34)}{this.renderLetra(35)}
          </div>
        </div>
      )  
    }
